...
Offer.create(name: "Announce a recent death", detail: "To ease the pain of the current lost I can help you do communicate it to others", price: 10000)
Offer.create(name: "Present a complaint to a store", detail: "If you don't want to go through the problems of getting your money back I can offer an easy solution", price: 10000)
Offer.create(name: "Decline a marriage propposal", detail: "To tell that person that they are not the one", price: 30000)
Offer.create(name: "OFfer Name", detail: "Description of the offer", price: 10000)
Offer.create(name: "OFfer Name", detail: "Description of the offer", price: 10000)
Offer.create(name: "OFfer Name", detail: "Description of the offer", price: 10000)
Offer.create(name: "OFfer Name", detail: "Description of the offer", price: 10000)
Offer.create(name: "OFfer Name", detail: "Description of the offer", price: 10000)
